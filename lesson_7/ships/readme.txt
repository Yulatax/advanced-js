Доработать пример, показанный на занятии до соответствия спецификации: Особое внимание обратить на
...
Корабль умеет передвигаться по морю (для упрощения - море везде, двигается по прямой). У корабля имеется якорь.
С опущенным якорем корабль передвигаться не может. Корабль должен иметь следующие свойства:
...
Корабль должен иметь возможность:
    ...
    Метод move(direction), который принимает направление (‘n’, ‘w’, ‘s’, ‘e’) и возвращает удалось ли передвинуться
