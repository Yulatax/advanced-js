...
// eRegistration('BH118_178', 'Petrov I. I.', makeTime(13, 45));
// eRegistration('BH18-178', 'Petrov I. I.', makeTime(13, 45));
// eRegistration('BH118-18', 'Petrov I. I.', makeTime(13, 45));
// eRegistration(a.id, 'Petrov I.I.', makeTime(13, 45));
// eRegistration(a.id, a.fullName, makeTime(15, 1));
// eRegistration(a.id, a.fullName, makeTime(9, 59));
eRegistration(a.id, a.fullName, makeTime(13, 26));
// eRegistration(a.id, a.fullName, makeTime(14, 0));
